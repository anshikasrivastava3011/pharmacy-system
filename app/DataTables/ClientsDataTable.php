        ...
        return (new EloquentDataTable($query))
            ...
            ->addColumn(
                ...
                <div class="d-flex flex-row justify-content-center btn-group btn-group-toggle" data-toggle="buttons">
                    <div class="d-flex flex-row gap-1">
                        ...
                        onclick="clientaddressshowmodalShow(event)"
                        id="{{$id}}"
            ...
            ->addColumn('Gender', function (Client $client) {
                if ($client->gender === 'Female') {
                    return '<img src="' . asset("dist/img/icons/Female-icon.png") . '" style="width:22px; height:22px; object-fit:contain; display:block; margin:auto;" />';
                } else {
                    return '<img src="' . asset("dist/img/icons/Male-icon.png") . '" style="width:22px; height:22px; object-fit:contain; display:block; margin:auto;" />';
                }
            })
