<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <!-- Logout -->
<li class="nav-item sidebar-list mt-2">
    <form id="logout-form" action="{{ route('logout') }}" method="POST">
        @csrf
        <button type="submit" class="nav-link border-0 bg-transparent text-white w-100 text-left">
            <img src="{{ asset('dist/img/icons/Logout-icon.png') }}" class="nav-icon" width="30">
